...
import 'schema/institutions1_record.dart';
import 'schema/top_institutions_record.dart';
...
export 'schema/institutions1_record.dart';
export 'schema/top_institutions_record.dart';
...
/// Functions to query Institutions1Records (as a Stream and as a Future).
Stream<List<Institutions1Record>> queryInstitutions1Record({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      Institutions1Record.collection,
...
Future<List<Institutions1Record>> queryInstitutions1RecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<Institutions1Record>> queryInstitutions1RecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
...
/// Functions to query TopInstitutionsRecords (as a Stream and as a Future).
Stream<List<TopInstitutionsRecord>> queryTopInstitutionsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      TopInstitutionsRecord.collection,
...
Future<List<TopInstitutionsRecord>> queryTopInstitutionsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<TopInstitutionsRecord>> queryTopInstitutionsRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
...
Future<FFFirestorePage<UserFriendsRecord>> queryUserFriendsRecordPage({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
