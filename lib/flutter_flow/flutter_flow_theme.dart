...
class LightModeTheme extends FlutterFlowTheme {
  late Color primaryColor = const Color(0xFF3004BE);
  late Color secondaryColor = const Color(0xFFF47D62);
  late Color tertiaryColor = const Color(0xFF6E0BD6);
  late Color alternate = const Color(0xFF39D2C0);
  late Color primaryBackground = const Color(0xFFF9F5F5);
  late Color secondaryBackground = const Color(0xFFF6EABE);
  late Color primaryText = const Color(0xFF222222);
  late Color secondaryText = const Color(0xFF95A1AC);

  late Color background = Color(0xFFF9F5F5);
  late Color darkBackground = Color(0xFFF6EABE);
  late Color grayDark = Color(0xFF57636C);
  late Color grayLight = Color(0xFF8B97A2);
  late Color errorRed = Color(0xFFC92919);
  late Color grayIcon = Color(0xFF95A1AC);
  late Color gray200 = Color(0xFFDBE2E7);
  late Color gray600 = Color(0xFF262D34);
  late Color black600 = Color(0xFF222222);
